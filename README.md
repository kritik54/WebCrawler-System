...
```bash
git clone https://github.com/USERNAME/WebCrawler-System.git
```

Navigate into the project:

```bash
cd WebCrawler-System
```
...
**Alvin Mwaura-bobitnrb115221 Grace Wanjiku Thairu bobitnrb610024- Tabitha Wanjiru bobinrb110625**
